  ...
  module Limits
    ...
    module ClassMethods
      ...
      CREDIT_LIMIT_HEADER_PARAM = {
        :shop => 'http_x_haravan_shop_api_call_limit'
      }
      ...
      # NOTE: subtracting 1 from credit_limit because I think HaravanAPI cuts off at 299 or shop limits.
      ...
      #
      def response
        Shop.current unless HaravanAPI::Base.connection.response
        HaravanAPI::Base.connection.response
      end
