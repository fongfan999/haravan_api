module HaravanAPI
  ...
  #   asset = HaravanAPI::Asset.new(:key => 'assets/special.css', :theme_id => 12345)
  # 
  # Find by key:
  #   asset = HaravanAPI::Asset.find('assets/image.png', :params => {:theme_id => 12345})
  # 
  ...
  #     
  #   * set a URL from which Haravan will fetch the value:
  ...
  class Asset < Base
    ...
    #   HaravanAPI::Asset.find('layout/theme.liquid', :params => {:theme_id => 99})
    def self.find(*args)
    ...
    # For text assets, Haravan returns the data in the 'value' attribute.
