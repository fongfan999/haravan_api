...
module HaravanAPI
  class Base < ActiveResource::Base
    ...
    self.headers['User-Agent'] = ["HaravanAPI/#{HaravanAPI::VERSION}",
    ...
    class << self
      ...
      def activate_session(session)
        ...
        self.headers.merge!('X-Haravan-Access-Token' => session.token)
      end

      def clear_session
        self.site = nil
        self.headers.delete('X-Haravan-Access-Token')
      end
