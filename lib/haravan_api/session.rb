  ...
  class Session
    ...
    class << self
      ...
      def temp(domain, token, &block)
        ...
        begin
          original_domain = host_with_port(HaravanAPI::Base.site.to_s)
        rescue URI::InvalidURIError
        end
        original_token   = HaravanAPI::Base.headers['X-Haravan-Access-Token']
        ...
        begin
          ...
          HaravanAPI::Base.activate_session(original_session)
        end
      end
      ...
      def prepare_url(url)
        ...
        url.concat(".myharavan.com") unless url.include?('.')   # extend url to myharavan.com if no host is given
      end
    ...
    def request_token(params)
      ...
      unless self.class.validate_signature(params) && params[:timestamp].to_i > 24.hours.ago.utc.to_i
        raise HaravanAPI::ValidationException, "Invalid Signature: Possible malicious login"
      end
