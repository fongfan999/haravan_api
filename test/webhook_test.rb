...
class WebhookTest < Test::Unit::TestCase
  test 'create should create a webhook' do
    ...
    webhook = HaravanAPI::Webhook.create(address: "http://www.yoloship.it/webhook", topic: "orders/create", format: "json")
