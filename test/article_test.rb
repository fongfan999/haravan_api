...
class ArticleTest < Test::Unit::TestCase
  ...
  def test_create_article
    ...
    article = HaravanAPI::Article.new(:blog_id => 1008414260)
    article.save
  ...
  def test_get_article
    ...
    article = HaravanAPI::Article.find(6242736)
    assert_equal "First Post", article.title
  ...
  def test_get_articles
    ...
    articles = HaravanAPI::Article.all
  ...
  def test_get_articles_namespaced
    ...
    articles = HaravanAPI::Article.find(:all, :params => {:blog_id => 1008414260})
    assert_equal 3, articles.length
    assert_equal 1008414260, articles.first.blog_id
  end
  ...
  def test_get_article_namespaced
    ...
    article = HaravanAPI::Article.find(6242736, :params => {:blog_id => 1008414260})
    assert_equal "First Post", article.title
    assert_equal 1008414260, article.blog_id
  end
  ...
  def test_get_authors
    ...
    authors = HaravanAPI::Article.authors
    assert_equal "Haravan", authors.first
  ...
  def test_get_authors_for_blog_id
    ...
    authors = HaravanAPI::Article.authors(:blog_id => 1008414260)
    assert_equal 3, authors.length
  end

  def test_get_tags
    fake "articles/tags", :method => :get, :body => load_fixture('tags')
    tags = HaravanAPI::Article.tags
  ...
  def test_get_tags_for_blog_id
    ...
    tags = HaravanAPI::Article.tags(:blog_id => 1008414260)
    assert_equal "consequuntur", tags.first
    assert_equal "repellendus", tags.last
  end
  ...
  def test_get_popular_tags
    ...
    tags = HaravanAPI::Article.tags(:popular => 1, :limit => 1)
